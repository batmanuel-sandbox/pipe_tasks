...
class AssembleCoaddTask(CoaddBaseTask):
    ...
    Notes
    -----
    The `pipeBase.cmdLineTask.CmdLineTask` interface supports a
    ...
    along with a list of Warps to attempt to coadd (specified using
    ...
    def assemble(self, skyInfo, tempExpRefList, imageScalerList, weightList,
        ...
        altMaskList : `list`, optional
            ...
            tempExp.
        mask : `afwImage.Mask`, optional
            Mask to ignore when coadding
        supplementaryData : pipeBase.Struct, optional
        ...
        result : `pipeBase.Struct`
           ...
           - ``coaddExposure``: coadded exposure (``afwImage.Exposure``).
           - ``nImage``: exposure count image (``afwImage.Image``).
        """
        tempExpName = self.getTempExpDatasetName(self.warpType)
    ...
    def assembleMetadata(self, coaddExposure, tempExpRefList, weightList):
        ...
        Parameters
        ----------
        coaddExposure : `afwImage.Exposure`
    ...
    def assembleSubregion(self, coaddExposure, bbox, tempExpRefList, imageScalerList, weightList,
        ...
        `afwMath.statisticsStack` with the statistic specified by
        statsFlags. Typically, the statsFlag will be one of afwMath.MEAN for
        a mean-stack or `afwMath.MEANCLIP` for outlier rejection using
        ...
        statsFlags : `afwMath.Property`
            Property object for statistic for coadd.
        statsCtrl : `afwMath.StatisticsControl`
            Statistics control object for coadd.
        nImage : `afwImage.ImageU`, optional
    ...
    def shrinkValidPolygons(self, coaddInputs):
        ...
        Parameters
        ----------
        coaddInputs : `afwImage.coaddInputs`
            Original mask.
...
def _subBBoxIter(bbox, subregionSize):
    ...
    subregionSize: `afwGeom.Extent2I`
        Size of sub-bboxes.
...
class AssembleCoaddDataIdContainer(pipeBase.DataIdContainer):
    """A version of `pipeBase.DataIdContainer` specialized for assembleCoadd.
    """
...
def countMaskFromFootprint(mask, footprint, bitmask, ignoreMask):
    ...
    footprint : `afwDetection.Footprint`
...
class CompareWarpAssembleCoaddTask(AssembleCoaddTask):
    ...
    def makeSupplementaryData(self, dataRef, selectDataList):
        ...
        result : `pipeBase.Struct`
           ...
           - ``templateCoaddcoadd``: coadded exposure (``afwImage.Exposure``).
        """
    ...
    def assemble(self, skyInfo, tempExpRefList, imageScalerList, weightList,
        ...
        result : `pipeBase.Struct`
           ...
           - ``coaddExposure``: coadded exposure (``afwImage.Exposure``).
           - ``nImage``: exposure count image (``afwImage.Image``), if requested.
        """
    ...
    def findArtifacts(self, templateCoadd, tempExpRefList, imageScalerList):
        ...
        Parameters
        ----------
        templateCoadd : `afwImage.Exposure`
    ...
    def filterArtifacts(self, spanSetList, epochCountImage, nImage, footprintsToExclude=None):
        ...
        spanSetList : `list`
            List of SpanSets representing artifact candidates.
        epochCountImage : `afwImage.Image`
            Image of accumulated number of warpDiff detections.
        nImage : `afwImage.Image`
